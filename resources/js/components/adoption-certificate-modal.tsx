    ...
    return (
        <>
            <Dialog open={open} onOpenChange={setOpen}>
                ...
                <DialogContent showCloseButton={false} className="sm:max-w-4xl max-h-[92vh] flex flex-col p-0 overflow-hidden bg-gray-100 dark:bg-neutral-900 border-none print:hidden">
                    {/* Modal Header */}
