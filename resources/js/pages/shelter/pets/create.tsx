...
export default function CreatePet({ shelters = [] }: { shelters: Shelter[] }) {
    ...
    return (
        <AppLayout breadcrumbs={[{ title: 'Manage Pets', href: route('admin.pets.index') }, { title: 'Add New Pet', href: '#' }]}>
            <Head title="Add New Pet Listing" />
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                            Add New Pet Listing <Sparkles className="w-5 h-5 text-[#D4A017]" />
                        </h1>
                        <p className="text-sm text-gray-500 dark:text-neutral-400">
                            Create a detailed pet profile to match with suitable adopters.
                        </p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Card className="border-gray-200 dark:border-neutral-800">
                        <CardHeader className="border-b border-gray-100 dark:border-neutral-800 pb-3">
                            ...
                            <CardDescription>Species, breed, age, and identity details.</CardDescription>
                        </CardHeader>
                        <CardContent className="pt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-2 col-span-1 md:col-span-2">
                                ...
                                {errors.shelter_id && <p className="text-xs text-red-500">{errors.shelter_id}</p>}
                            </div>
                    ...
                    <Card className="border-gray-200 dark:border-neutral-800">
                        <CardHeader className="border-b border-gray-100 dark:border-neutral-800 pb-3">
                            ...
                            <CardDescription>Energy level, health status, and temperament traits used for DSS matching.</CardDescription>
                        </CardHeader>
                    ...
                    <Card className="border-gray-200 dark:border-neutral-800">
                        <CardHeader className="border-b border-gray-100 dark:border-neutral-800 pb-3">
                            ...
                            <CardDescription>Set home environment constraints for adoption screening.</CardDescription>
                        </CardHeader>
                        <CardContent className="pt-6 space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                {errors.housing_compatible && (
                                    <p className="text-xs text-red-500">{errors.housing_compatible}</p>
                                )}
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-t border-gray-100 dark:border-neutral-800 pt-4">
                                <label className="flex items-start gap-3 p-3 rounded-lg border border-gray-200 dark:border-neutral-800 cursor-pointer">
                                    ...
                                    />
                                    <div>
                                        <span className="text-xs font-semibold block text-gray-800 dark:text-neutral-200">
                                            Requires Fenced Yard
                                        </span>
                                        <span className="text-[11px] text-gray-500 dark:text-neutral-400">
                                            Pet needs an outdoor fenced yard space.
                                        </span>
                                    </div>
                                </label>
                                ...
                                <label className="flex items-start gap-3 p-3 rounded-lg border border-gray-200 dark:border-neutral-800 cursor-pointer">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-[11px] text-gray-500 dark:text-neutral-400">
                                            Best suited for prior pet owners.
                                        </span>
                                    </div>
                                </label>
                                ...
                                <label className="flex items-start gap-3 p-3 rounded-lg border border-gray-200 dark:border-neutral-800 cursor-pointer">
                                    ...
                                    <div>
                                        <span className="text-xs font-semibold block text-gray-800 dark:text-neutral-200">
                                            No Small Children (&lt; 10 yrs)
                                        </span>
                                        <span className="text-[11px] text-gray-500 dark:text-neutral-400">
                                            Pet prefers calm, adult-only environments.
                                        </span>
                                    </div>
                                </label>
