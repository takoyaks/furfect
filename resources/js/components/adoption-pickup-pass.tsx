...
export function AdoptionPickupPass({ application, className = '' }: AdoptionPickupPassProps) {
    ...
    return (
        <div
            className={`print-pass-document bg-white text-gray-950 font-sans p-6 print:p-4 max-w-3xl mx-auto border-2 border-gray-900 rounded-none shadow-none text-xs leading-normal ${className}`}
            style={{
        ...
        >
            {/* Official LGU Header */}
            <div className="text-center border-b-2 border-gray-900 pb-2 mb-3 print:pb-1.5 print:mb-2 space-y-0.5">
                <div className="text-[10px] tracking-widest uppercase font-semibold text-gray-700">
                ...
                <div className="pt-1.5">
                    <span className="inline-block bg-gray-900 text-white font-black text-xs tracking-wide px-3 py-0.5 uppercase rounded-xs">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 bg-gray-50 border border-gray-900 p-2 mb-3 print:mb-2 text-[11px]">
                <div>
                    <span className="text-[9px] font-bold uppercase text-gray-600 block">Certificate No.</span>
                    <span className="font-mono font-black text-gray-900">{certNumber}</span>
                </div>
                <div>
                    <span className="text-[9px] font-bold uppercase text-gray-600 block">Application Ref</span>
                    <span className="font-mono font-bold text-gray-900">{application.reference_number}</span>
                </div>
                <div>
                    <span className="text-[9px] font-bold uppercase text-gray-600 block">Approval Date</span>
                    <span className="font-semibold text-gray-900">{issueDate}</span>
                </div>
                <div>
                    <span className="text-[9px] font-bold uppercase text-red-700 block">Claim Deadline</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                {/* Adopter Information */}
                <div className="border border-gray-900 p-3 space-y-2">
                    <div className="font-bold text-[11px] uppercase tracking-wide border-b border-gray-300 pb-1 flex items-center justify-between">
                        <span>I. Adopter Details</span>
                        <span className="text-[9px] text-gray-500 font-normal">Legal Custodian</span>
                    </div>
                    <div className="space-y-1 text-[11px]">
                        <div>
                            <span className="text-gray-500 block text-[10px]">Full Name:</span>
                            <span className="font-bold text-gray-900 text-xs">{adopterName}</span>
                        </div>
                        <div>
                            <span className="text-gray-500 block text-[10px]">Contact Number:</span>
                            <span className="font-medium text-gray-900">{adopterContact}</span>
                        </div>
                        <div>
                            <span className="text-gray-500 block text-[10px]">Residential Address:</span>
                            <span className="font-medium text-gray-900">{adopterAddress}</span>
                        </div>
                        <div>
                            <span className="text-gray-500 block text-[10px]">Identity Verification:</span>
                ...
                <div className="border border-gray-900 p-3 space-y-2">
                    <div className="font-bold text-[11px] uppercase tracking-wide border-b border-gray-300 pb-1 flex items-center justify-between">
                        ...
                        <span className="text-[9px] text-gray-500 font-normal">Municipal Ward</span>
                    </div>
                    <div className="space-y-1 text-[11px]">
                        <div className="flex justify-between">
                            <div>
                                <span className="text-gray-500 block text-[10px]">Pet Name:</span>
                                <span className="font-black text-gray-900 text-xs">{application.pet.name}</span>
                            </div>
                            <div className="text-right">
                                <span className="text-gray-500 block text-[10px]">Species / Breed:</span>
                        ...
                        <div className="grid grid-cols-2 gap-2 pt-1">
                            <div>
                                <span className="text-gray-500 block text-[10px]">Sex &amp; Age:</span>
                                <span className="font-medium text-gray-900 capitalize">
                                    {application.pet.gender || 'Unknown'} &bull; ~{application.pet.age_years || 1} yr(s)
                                </span>
                            </div>
                            <div>
                                <span className="text-gray-500 block text-[10px]">Collar Tag No.:</span>
                        ...
                        <div className="pt-1 border-t border-gray-100 flex justify-between items-center text-[10px]">
            ...
            <div className="border border-gray-900 p-2.5 print:p-2 mb-2.5 print:mb-2 bg-gray-50/70 space-y-1">
                <div className="font-bold text-[11px] uppercase tracking-wide border-b border-gray-200 pb-0.5 flex items-center justify-between">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-[10px] text-gray-800 pt-0.5">
                    <div className="p-1.5 bg-white border border-gray-200">
            ...
            <div className="border border-gray-900 p-2.5 print:p-2 mb-2.5 print:mb-2 text-[9.5px] leading-relaxed text-gray-800 bg-white">
                <div className="font-bold uppercase tracking-wider text-gray-900 mb-0.5 text-[10px]">
            ...
            <div className="border border-gray-900 p-3 print:p-2.5 mb-2">
                <div className="text-[10px] font-bold uppercase tracking-wider text-gray-700 border-b border-gray-200 pb-0.5 mb-3 print:mb-2">
                ...
                <div className="grid grid-cols-3 gap-4 text-center text-[10px]">
                    ...
                    <div className="space-y-1 flex flex-col justify-end">
                        <div className="h-9 border-b border-gray-900 flex items-end justify-center pb-0.5 font-mono text-[9px] text-gray-400">
                            [Digitally Verified]
                        </div>
                        <span className="font-bold uppercase text-gray-900 block text-[10px] pt-1">
                    ...
                    {/* Releasing Officer */}
                    <div className="space-y-1 flex flex-col justify-end">
                        <div className="h-9 border-b border-gray-900 flex items-end justify-center pb-0.5">
